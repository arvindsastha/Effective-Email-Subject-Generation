...
class MatchDataset(CnnDmDataset):
    ...
    def __getitem__(self, i):
        ...
        art_sents, abs_sents, extracts = (js_data['email_body'], js_data['subject'], js_data['extracted'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vsize', type=int, action='store', default=9601,
    ...
    # length limit
    parser.add_argument('--max_art', type=int, action='store', default=156,
